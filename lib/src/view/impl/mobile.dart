...
import 'package:miladtech_webviewx/src/controller/impl/mobile.dart';
...
class _WebViewXState extends State<WebViewX> {
  ...
  Widget build(BuildContext context) {
    ...
    originalWebViewController.setNavigationDelegate(wf.NavigationDelegate(
      onWebResourceError: onWebResourceError,
      onPageFinished: widget.onPageFinished,
      onPageStarted: widget.onPageStarted,
      onNavigationRequest: navigationDelegate
    ));
    //originalWebViewController.addJavaScriptChannel(javascriptChannelss);
